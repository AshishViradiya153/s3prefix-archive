 ...
 * each URL and can feed bytes into a client-side ZIP library (not shipped with s3flow).
 *
 * Install: `s3flow`, `@aws-sdk/client-s3`. IAM on this role: `s3:ListBucket` on the prefix +
